...
export interface FilterBuilderProps {
  // Available fields can have a one to many relationship with the filters, i.e. a field can be used in multiple
  // filters with different constraints.
  availableFields: Array<FilterRowOption>;
  // Array of FilterInputs used only to seed the initial state. The component owns the draft state internally and
  // will not sync with changes to this prop. To reset the component, change its key prop.
