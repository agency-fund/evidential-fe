...
export const OIDC_REDIRECT_URI = process.env.NEXT_PUBLIC_XNGIN_OIDC_REDIRECT_URI;
export const PRODUCT_NAME = 'Evidential';
export const SUPPORT_EMAIL = 'evidential-support@agency.fund';
export const XNGIN_API_DOCS_LINK = process.env.NEXT_PUBLIC_XNGIN_API_DOCS ?? 'https://main.dev.agencyfund.org/docs';
