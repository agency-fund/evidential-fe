    ...
    'describe-bandit-arms': screen({
      ...
      reducer: (data, msg) => {
        ...
        if (msg.type === 'add-arm') {
          ...
          const newArm =
            priorType === 'beta'
              ? { arm_name: '', arm_description: '', alpha_prior: undefined, beta_prior: undefined, arm_weight: 50.0 }
              : { arm_name: '', arm_description: '', mean_prior: undefined, stddev_prior: undefined, arm_weight: 50.0 };
