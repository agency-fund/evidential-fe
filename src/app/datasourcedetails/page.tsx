...
export default function Page() {
  ...
  const { data: datasourceDetails, isLoading: datasourceDetailsLoading } = useGetDatasource(datasourceId!, {
    swr: {
      enabled: datasourceId !== null,
    },
  });

  const { data, isLoading: inspectDatasourceLoading } = useInspectDatasource(datasourceId!, {
    swr: {
      enabled: datasourceId !== null,
    },
  });
  ...
  if (
    ...
    !isSuccessResponse(datasourceDetails) ||
    datasourceId === null
  ) {
    // TODO
    return (
