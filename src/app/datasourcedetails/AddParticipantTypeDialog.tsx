...
const AddParticipantTypeDialogInner = (
    {datasourceId, tables}: { datasourceId: string, tables: string[] }) => {
    ...
    return (
        <Dialog.Root open={open} onOpenChange={setOpen}>
            <Dialog.Trigger>
                <Button><PlusIcon/> Add Participant Type</Button>
            </Dialog.Trigger>
                ...
                {isMutating ? <Spinner/> :
                    <form onSubmit={async (event) => {
                        ...
                        <Flex direction="column" gap="3">
                            ...
                            {loadingTableData ? <Spinner/> : selectedTable === "" ?
