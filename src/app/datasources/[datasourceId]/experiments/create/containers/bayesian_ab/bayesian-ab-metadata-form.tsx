...
import { BayesianABFormData, BayesianABArm } from '@/app/datasources/[datasourceId]/experiments/create/types';
import { NavigationButtons } from '@/components/features/experiments/navigation-buttons';
import { SectionCard } from '@/components/ui/cards/section-card';

interface BayesianABMetadataFormProps {
...
export function BayesianABMetadataForm({ 
  formData, 
  onFormDataChange, 
  onNext, 
  onBack 
}: BayesianABMetadataFormProps) {
  
  const updateBasicInfo = (field: keyof BayesianABFormData, value: any) => {
    onFormDataChange({
      ...formData,
      [field]: value,
    });
