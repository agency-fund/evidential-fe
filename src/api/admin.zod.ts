...
export const getCmabExperimentAssignmentForParticipantResponseAssignmentStrataItemFieldNameRegExp =
	new RegExp("^[a-zA-Z_][a-zA-Z0-9_]*$");
export const getCmabExperimentAssignmentForParticipantResponseAssignmentStrataMaxOne = 150;
export const getCmabExperimentAssignmentForParticipantResponseAssignmentContextValuesMaxOne = 10;

export const getCmabExperimentAssignmentForParticipantResponse = zod
	.object({
		experiment_id: zod.string(),
		participant_id: zod.string(),
		assignment: zod
			.object({
				...
				participant_id: zod
					.string()
					.max(
						getCmabExperimentAssignmentForParticipantResponseAssignmentParticipantIdMax,
					)
					.describe(
						"Unique identifier for the participant. This is the primary key for the participant in the data warehouse.",
					),
				arm_name: zod
					.string()
					.max(
						getCmabExperimentAssignmentForParticipantResponseAssignmentArmNameMax,
					)
					.describe(
						"The arm this participant was assigned to. Same as Arm.arm_name.",
					),
				...
				strata: zod
						...
						zod
							.object({
								field_name: zod
									.string()
									.regex(
										getCmabExperimentAssignmentForParticipantResponseAssignmentStrataItemFieldNameRegExp,
									),
								strata_value: zod.string().or(zod.null()).optional(),
							})
							.describe(
					...
					.max(
						getCmabExperimentAssignmentForParticipantResponseAssignmentStrataMaxOne,
					)
					.or(zod.null())
					.optional()
					.describe(
				...
				context_values: zod
					.array(zod.number())
					.max(
						getCmabExperimentAssignmentForParticipantResponseAssignmentContextValuesMaxOne,
					)
					.or(zod.null())
					.optional()
					.describe(
