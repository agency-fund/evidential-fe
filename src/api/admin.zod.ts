						...
						zod
							.object({
								...
								description: zod
									.string()
									.max(
										listExperimentsResponseItemsItemDesignSpecDescriptionMax,
									),
								start_date: zod.string().datetime({}),
								end_date: zod.string().datetime({}),
								arms: zod
								...
								power: zod
									...
									.default(
										listExperimentsResponseItemsItemDesignSpecPowerDefault,
									)
									.describe(
										"The chance of detecting a real non-null effect, i.e. 1 - false negative rate.",
									),
								alpha: zod
									...
									.default(
										listExperimentsResponseItemsItemDesignSpecAlphaDefault,
									)
									.describe(
										"The chance of a false positive, i.e. there is no real non-null effect, but we mistakenly think there is one.",
									),
