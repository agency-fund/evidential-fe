 ...
 */
export type getStrataResponse200 = {
	data: GetStrataResponse;
	status: 200;
};

export type getStrataResponse422 = {
	data: HTTPValidationError;
	status: 422;
};

export type getStrataResponseComposite =
	| getStrataResponse200
	| getStrataResponse422;

export type getStrataResponse = getStrataResponseComposite & {
	headers: Headers;
};
 ...
 */
export type getFiltersResponse200 = {
	data: GetFiltersResponse;
	status: 200;
};

export type getFiltersResponse422 = {
	data: HTTPValidationError;
	status: 422;
};

export type getFiltersResponseComposite =
	| getFiltersResponse200
	| getFiltersResponse422;

export type getFiltersResponse = getFiltersResponseComposite & {
	headers: Headers;
};
...
export type getMetricsResponse422 = {
	data: HTTPValidationError;
	status: 422;
};

export type getMetricsResponseComposite =
	| getMetricsResponse200
	| getMetricsResponse422;
 ...
 */
export type assignTreatmentResponse200 = {
	data: AssignResponseOutput;
	status: 200;
};

export type assignTreatmentResponse422 = {
	data: HTTPValidationError;
	status: 422;
};

export type assignTreatmentResponseComposite =
	| assignTreatmentResponse200
	| assignTreatmentResponse422;

export type assignTreatmentResponse = assignTreatmentResponseComposite & {
	headers: Headers;
};
